<nav class="navbar navbar-expand-sm bg-success navbar-dark sticky-top">
  <a class="navbar-brand" href="#">Sereal</a>
</nav>
<br>
<div class="container-fluid">
  <div class="container-fluid">
      <div class="row">
        <div class="col-6">
            <a href="<?php echo base_url() ?>android/sereal_section/varietas">
            <div class="card bg-success">
              <div class="card-body text-center">
                 <img class="img-fluid" src="<?php echo base_url() ?>asset/android/sereal.png">
        ...
        <div class="col-6">
            <a href="<?php echo base_url() ?>android/sereal_section/budidaya">
            <div class="card bg-success">
              <div class="card-body text-center">
      ...
      <div class="row">
        <div class="col-6">
            <a href="<?php echo base_url() ?>android/sereal_section/hitungpupuk">
            <div class="card bg-success">
              <div class="card-body text-center">
        ...
        <div class="col-6">
            <a href="<?php echo base_url() ?>android/sereal_section/analisis">
            <div class="card bg-success">
              <div class="card-body text-center">
