<nav class="navbar navbar-expand-sm bg-success navbar-dark sticky-top">
  <a class="navbar-brand" href="#">Padi</a>
</nav>
<br>
<div class="container-fluid">
  <div class="container-fluid">
      <div class="row">
        <div class="col-6">
            <a href="<?php echo base_url() ?>android/padi_section/varietas">
        ...
        <!-- hidden
        <div class="col-6">
            <a href="<?php echo base_url() ?>android/padi_section/budidaya">
            <div class="card bg-success">
              <div class="card-body text-center">
      ...
      <div class="row">
        <div class="col-6">
            <a href="<?php echo base_url() ?>android/padi_section/hitungpupuk">
            <div class="card bg-success">
              <div class="card-body text-center">
        ...
        <div class="col-6">
            <a href="<?php echo base_url() ?>android/padi_section/analisis">
            <div class="card bg-success">
              <div class="card-body text-center">
