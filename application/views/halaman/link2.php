<div class="container">
    ...
    <div class="col-12">
        <div class="card text-dark mt-1">
          <div class="card-body">
            <h3 style="text-align:center;color:black;">Seminar Peternakan Optimalisasi Produksi Ayam Lokal Persilangan</h3>
                ...
                <table class="table table-bordered">
                  ...
                  <table class="table table-bordered">
                    <thead>
                      <tr>
                        <th colspan="2">Link Sertifikat Peserta</th>
                      </tr>
                    </thead>
                    <tbody>
                      <?php
                        $qw = $this->db->query("select * from sertifikat where pemateri = 0")->result();
                        foreach($qw as $q){
                      ?>
                      <tr>
                        <td><?= $q->nama ?></td>
                        <td><a target="_blank" href="https://new.gorontalo.litbang.pertanian.go.id/web/bptp/sertifikat2/<?= $q->id ?>?left=380" class="btn btn-success">Download Sertifikat</a></td>
                      </tr>
                      <?php } ?>
                    </tbody>
                  </table>
