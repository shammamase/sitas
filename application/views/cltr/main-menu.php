      ...
      <!--<div class="container">-->
          ...
          <nav class="classy-navbar justify-content-between" id="alazeaNav">
              ...
              <?php 
               ...
               ?>
              <a style="margin-left:30px;" href="<?php echo site_url('Utama_cltr') ?>" class="nav-brand"><img src="<?php echo base_url(); ?>template/<?php echo template_cltr(); ?>/assets/img/core-img/<?php echo $lg->logo ?>" alt=""></a>
                  ...
                  <div class="classynav">
                      <ul>
                          ...
                          <li><a href="#"><?php echo $qm->judul ?></a>
                            <ul class="dropdown">
                              <?php 
                                $sub_mn = $this->db->query("SELECT * FROM halamanstatis WHERE id_halaman IN ($qm->sekunder) ORDER BY no_menu ASC")->result();
