            ...
            <div class="col-12 col-md-4">
                <div class="post-sidebar-area">
                    ...
                    <div class="single-widget-area">
                        ...
                        <?php 
                            $popular_div = $this->db->query("SELECT a.*,b.nama_lengkap FROM cltr_post a INNER JOIN users b ON a.username=b.username WHERE a.acc = 1 AND a.id_page IN ($id_page) ORDER BY a.id_post DESC LIMIT 5")->result();
