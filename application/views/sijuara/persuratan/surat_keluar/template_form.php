...
<div class="wrapper">
    ...
    <ul class="navbar-nav">
     ...
     <!-- Right navbar links -->
            <ul class="navbar-nav ml-auto">
              <li class="nav-item">
                <a href="<?php echo base_url(); ?>sijuara/homex/<?= $uris ?>"><i class="fa fa-home"></i> Menu Utama </a>
              </li>
              <li class="nav-item">
                <a href="#">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </a>
              </li>
  ...
  <?php $users = $this->model_users->users_edit_sijuara($this->session->username)->row_array(); ?>
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="<?php echo site_url('sijuara/homex/') ?><?= $uris ?>" class="brand-link">
             ...
             ?>
              <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                  ...
                  <li class="nav-item">
                    <a href="<?php echo base_url(); ?>sijuara/homex/<?= $uris ?>" class="nav-link">
                  ...
                  <li class="nav-item">
                    <a href="<?php echo base_url(); ?>sijuara/buat_surat_masuk/<?= $uris ?>" class="nav-link">
                  ...
                  <li class="nav-item">
                    <a href="<?php echo base_url(); ?>sijuara/buat_surat_keluar/<?= $uris ?>" class="nav-link">
                      <i class="fa fa-list"></i>
                      <p>
                        Surat Keluar
                      </p>
                  ...
                  <li class="nav-item">
                    <a href="<?php echo base_url(); ?>sijuara/buat_surat/<?= $uris ?>" class="nav-link">
                      <i class="fa fa-list"></i>
                      <p>
                        Buat Surat
                      </p>
                  ...
                  <li class="nav-item">
                    <a href="<?php echo base_url(); ?>sijuara/daftar_surat/<?= $uris ?>" class="nav-link">
                      <i class="fa fa-list"></i>
                      <p>
                        Daftar Surat
                      </p>
                  ...
                  <?php if($lev->id_stakeholder==8){ ?>
                  <li class="nav-item">
                    <a href="<?php echo base_url(); ?>sijuara/pejabat_tanda_tangan" class="nav-link">
                      <i class="fa fa-list"></i>
                      <p>
