	   ...
	   <?php
		...
		<table style="margin-left:10%;margin-top:10px;width:80%" border="0">
          <tr>
              ...
              <td style="width:65%;text-align:justify;vertical-align:top">
                  <?php
                    foreach($peg as $pg){
                        $tgl_plk = $pg->tanggal;
                        ?>
          ...
          <tr>
              <td colspan="3" style="width:100%;vertical-align:top"><?= stripslashes($lap_spt->uraian) ?></td>
          </tr>
        </table>
        ...
        <table style="margin-left:10%;margin-top:10px;width:80%" border="0">
          ...
          <tr>
              <td style="width:55%;height:60px;text-align:justify;vertical-align:top">&nbsp;</td>
              <td style="width:45%;height:60px;text-align:justify;vertical-align:top">&nbsp;</td>
          </tr>
          <tr>
