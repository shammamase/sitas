...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <!-- Right navbar links -->
            <ul class="navbar-nav ml-auto">
              <li class="nav-item">
                <a href="<?php echo base_url(); ?>sijuara/homex/<?= $uri3 ?>"><i class="fa fa-home"></i> Menu Utama </a>
              </li>
              <li class="nav-item">
                <a href="#">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </a>
              </li>
  ...
  <?php $users = $this->model_users->users_edit_sijuara($this->session->username)->row_array(); ?>
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="<?php echo site_url('sijuara/homex/<?= $uri3 ?>') ?>" class="brand-link">
             ...
             ?>
              <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                  ...
                  <li class="nav-item">
                    <a href="<?php echo base_url(); ?>sijuara/homex/<?= $uri3 ?>" class="nav-link">
                  ...
                  <li class="nav-item">
                    <a href="<?php echo base_url(); ?>sijuara/buat_spt/<?= $uri3 ?>" class="nav-link">
                  ...
                  <?php } ?>
                  <li class="nav-item">
                    <a href="<?php echo base_url(); ?>sijuara/daftar_spt/<?= $uri3 ?>" class="nav-link">
                      <i class="fa fa-list"></i>
                      <p>
                        Daftar SPT
                      </p>
                  ...
                  <li class="nav-item">
                    <a href="<?php echo base_url(); ?>sijuara/buat_lap_spt/<?= $uri3 ?>" class="nav-link">
                      <i class="fa fa-list"></i>
                      <p>
                        Laporan SPT
                      </p>
