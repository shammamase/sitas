	...
	<body>
	   <?php
        ...
        <table style="margin-left:30%;margin-top:10px;width:60%" border="0">
          ...
          <tr>
              <td style="vertical-align:top;text-align:center"><img style="height:80px; width:auto" src="<?= base_url() ?>asset/file_lainnya/qr_code_spt/<?= $spt->id_spt ?>.png"></td>
              <!--<td style="text-align:justify;vertical-align:top"><img src="<?= base_url().$kabalai->ttd ?>"></td>-->
              <td style="text-align:justify;vertical-align:top;line-height:30px"></td>
