...
<div class="wrapper">
  ...
  <?php $users = $this->model_users->users_edit_sijuara($this->session->username)->row_array(); ?>
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="<?php echo site_url('sijuara/homex') ?>" class="brand-link">
            ...
            <div class="sidebar">
              ...
              <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                  ...
                  <li class="nav-item">
                    <a href="<?php echo base_url(); ?>utama/master_rkakl" class="nav-link">
                  ...
                  <li class="nav-item">
                    <a href="<?php echo base_url(); ?>utama/buat_subdetil" class="nav-link">
                      <i class="fa fa-list"></i>
                      <p>
                        Buat Detil/Subdetil
                      </p>
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; <?php echo date('Y'); ?> <a target='_BLANK' href="<?php echo site_url('Utama_cltr') ?>"> BPSIP Gorontalo</a>.</strong> All rights reserved.
