...
<div class="modal-dialog modal-xl">
  <div class="modal-content">
    ...
    <div class="modal-body">
        <?php
        $get_program = $this->model_polling->get_program()->row();
        $attributes = array('class'=>'form-horizontal','role'=>'form');
              echo form_open('sijuara/verif_pj',$attributes);
        ?>
          ...
          <input type="hidden" name="no_hp" value="<?php echo $get_program->no_hp ?>">
          <input type="hidden" name="links" value="<?php echo base_url() ?>sijuara/verif/<?php echo $uris ?>/2">
