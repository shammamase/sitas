    ...
    <table id="example1" class="table table-bordered table-striped">
     ...
     ?>
      <tr>
        ...
        <td>
            <a class='btn btn-warning btn-xs' title='Lihat' href="<?php echo base_url() ?>sekunder/verif_cuti2/<?php echo $row->id_cuti ?>/<?= get_kode_uniks($row->id_cuti) ?>"><i class='fas fa-file'></i> Verifikasi</a>
        </td>
      </tr>
     <?php
      $no++;
