...
<div class="wrapper">
    ...
    <div class="preloader flex-column justify-content-center align-items-center">
        ...
        <img class="animation__shake" src="<?php echo base_url(); ?>/asset/gambar/loader.png" alt="AdminLTELogo">
    </div>
  <!-- Navbar -->
  ...
  ?>
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="<?php echo site_url('primer/home') ?>" class="brand-link">
              <img src="<?php echo base_url(); ?>asset/gambar/lalu_lintas_data.png" alt="Sijuara Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
              <span class="brand-text font-weight-light">LinTAS</span>
            </a>
            ...
            <div class="sidebar">
              ...
              <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                  ...
                  <li class="nav-item">
                    <a href="<?php echo base_url(); ?>primer/daftar_spt" class="nav-link">
                      <i class="fa fa-list"></i>
                      <p>
                        Daftar SPT
                      </p>
