<?php 
    echo "<div class='col-md-12'>
              ...
              echo form_open_multipart('admin/edit_manajemenuser',$attributes); 
          echo "<div class='col-md-12'>
            ...
            echo    "<tr><th scope='row'>No Telp</th>                  <td><input type='number' class='form-control' name='e' value='$rows[no_telp]'></td></tr>
