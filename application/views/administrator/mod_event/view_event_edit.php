<?php 
    echo "<div class='col-md-12'>
              ...
              echo form_open_multipart('admin/edit_event',$attributes); 
          echo "<div class='col-md-12'>
                  ...
                  <tbody>
                    ...
                    <tr><th scope='row'>Ganti Gambar</th>                 <td><input type='file' class='form-control' name='e'>";
                                                                               if ($rows['gambar'] != ''){ echo "<i style='color:red'>Lihat Gambar Saat ini : </i><a target='_BLANK' href='".base_url()."asset/foto_event/$rows[gambar]'>$rows[gambar]</a>"; } echo "</td></tr>
              ...
              <div class='box-footer'>
                    ...
                    <a href='".base_url().$this->uri->segment(1)."/event'><button type='button' class='btn btn-default pull-right'>Cancel</button></a>
